...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{route('admin.establishment.update',$establishment->id)}}" method="post" enctype="multipart/form-data" >
                    @method('PUT')
                    @csrf
                    <div class="row">
        ...
        <table class="table datatable-save-state">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form action="{{route('admin.establishment_shop.destroy',$shop->id)}}" method="POST">
                            @method('DELETE')
                            @csrf
...
<div id="add_new_shop_modal" class="modal fade">
    <div class="modal-dialog">
        <form action="{{route('admin.establishment_shop.store')}}" method="POST" enctype="multipart/form-data">
            @csrf
...
<script>
    $(document).ready(function(){
        $('.edit-btn').click(function(){
            ...
            $('#id').val(id);
            $('#updateForm').attr('action','{{route('admin.establishment_shop.update','')}}' +'/'+id);
        });
    });
</script>
@endsection