...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{route('super_admin.structure.store')}}" method="post" enctype="multipart/form-data" >
                    @csrf
                    <div class="row">
    ...
    <table class="table datatable-save-state">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <form action="{{route('super_admin.structure.destroy',$structure->id)}}" method="POST">
                        @method('DELETE')
                        @csrf
...
<script>
    $(document).ready(function(){
        $('.edit-btn').click(function(){
            ...
            $('#name').val(name);
            $('#id').val(id);
            $('#updateForm').attr('action','{{route('super_admin.structure.update','')}}' +'/'+id);
        });
    });
</script>
@endsection